...
numerical_features = ['Viral_Load', 'CD4_Count', 'Adherence_Level', 'Strain_Type']  
sequence_features = [f'Sequence_{i}' for i in range(1, 401)]  
...
print(data_pred_zeros[numerical_features + sequence_features]) 
